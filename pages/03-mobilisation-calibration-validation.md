...
9. Perform all manufacturer’s self-tests and calibrations (positioning system, swath sonar, sound velocity instruments) to ensure validity of entire system. This includes a patch test ([section 3.5](#heading=h.43ky6rz))
10. Record all sign conventions and calibrated geometries of installed sensors (screen captures and reports;[section 6.1](#heading=h.zu0gcz)).
